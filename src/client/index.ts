...
const tabs = [
  {
    btn: document.getElementById('tab-products') as HTMLButtonElement,
    section: document.getElementById('products-section') as HTMLDivElement
  },
  {
    btn: document.getElementById('tab-users') as HTMLButtonElement,
    section: document.getElementById('users-section') as HTMLDivElement
  }
]
